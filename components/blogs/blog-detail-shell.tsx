      ...
      <aside className="space-y-6 xl:sticky xl:top-28 xl:self-start" data-testid="blog-meta-rail">
        ...
        <section className="space-y-4 border border-border/70 bg-card/68 p-5">
          <div className="space-y-3">
            <p className="kicker text-muted-foreground">Author</p>
              ...
              <div className="relative h-10 w-10 overflow-hidden rounded-full bg-primary text-primary-foreground flex items-center justify-center">
                {authorAvatar ? (
                  ...
                  <span className="text-sm font-bold uppercase">
                    {(authorName ?? "J").charAt(0)}
                  </span>
                )}
              </div>
              <p className="type-body text-foreground font-bold leading-tight">
                {authorName ?? "Jotin Kumar Madugula"}
              </p>
            </div>
          </div>
