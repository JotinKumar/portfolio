...
export function ProfileSidebarBlock({
  ...
  return (
    <section
      className={cn(
        "relative space-y-4 overflow-hidden pt-6 before:absolute before:left-0 before:right-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-border/60 before:to-transparent first:pt-0 first:before:hidden lg:grid lg:grid-cols-[2.75rem_minmax(0,1fr)] lg:gap-5 lg:space-y-0",
        className
      )}
    >
