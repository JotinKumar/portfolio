      ...
      >
        <div className={`${current ? "h-[480px]" : "h-[432px]"} w-full max-w-xl flex flex-col py-2 overflow-hidden`}>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div data-testid="home-hero-actions" className={`flex flex-col sm:flex-row gap-4 transition-all duration-700 ${isInitial ? "scale-90 origin-left" : ""}`}>
              <Button asChild className="!rounded-none px-8 py-5 text-base shadow-lg transition-all hover:shadow-primary/20 active:scale-95">
                <a href={resumeUrl}>{heroContent.downloadResumeLabel}</a>
              </Button>
              <Button variant="outline" asChild className="!rounded-none border-2 px-8 py-5 text-base transition-all hover:bg-primary/5 active:scale-95">
