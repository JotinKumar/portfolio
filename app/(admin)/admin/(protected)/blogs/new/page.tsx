...
async function createBlog(formData: FormData) {
  ...
  if (!title || !slug) {
    redirect("/admin/blogs/new?error=missing_required_fields");
  }
  ...
  revalidatePath("/");
  redirect("/admin/blogs?success=blog_created");
}
...
export default function NewBlogPage() {
  return (
    <div className="space-y-6">
      <AdminPageHeader
        title="New Blog"
        description="Create a new blog draft or publish it immediately."
        action={
